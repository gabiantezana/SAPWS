...
namespace SAPWS.DATAACCESS
{
    public class PaymentDataAccess
    {
        ...
        public Fields GetCashAccount(Company company, String medioPagoSAP, String currency)
        {
            String query = new QueryConstructorHelper(company.DbServerType).GetCashAccountForIncommingPayment(medioPagoSAP, currency);
